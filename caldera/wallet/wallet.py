...
from caldera.consensus.cost_calculator import calculate_cost_of_program, NPCResult
from caldera.full_node.bundle_tools import simple_solution_generator
...
from caldera.types.announcement import Announcement
...
from caldera.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import (
    DEFAULT_HIDDEN_PUZZLE_HASH,
    calculate_synthetic_secret_key,
    puzzle_for_pk,
    solution_for_conditions,
)
from caldera.wallet.puzzles.puzzle_utils import (
...
from caldera.wallet.secret_key_store import SecretKeyStore
from caldera.wallet.sign_coin_solutions import sign_coin_solutions
...
class Wallet:
    ...
    async def create_spend_bundle_relative_caldera(self, caldera_amount: int, exclude: List[Coin]) -> SpendBundle:
        list_of_solutions = []
        utxos = None
        ...
        if caldera_amount < 0:
            utxos = await self.select_coins(abs(caldera_amount), exclude)
        else:
        ...
        caldera_amount = spend_value + caldera_amount
        ...
        for coin in utxos:
            ...
            if output_created is None:
                ...
                primaries = [{"puzzlehash": newpuzhash, "amount": caldera_amount}]
