...
from caldera.pools.pool_config import PoolWalletConfig, load_pool_config, update_pool_config
from caldera.pools.pool_wallet_info import (
    PoolWalletInfo,
    PoolSingletonState,
    PoolState,
    FARMING_TO_POOL,
...
from caldera.protocols.pool_protocol import POOL_PROTOCOL_VERSION
...
from caldera.pools.pool_puzzles import (
...
from caldera.util.ints import uint8, uint32, uint64
...
class PoolWallet:
    ...
    async def create_new_pool_wallet_transaction(
        ...
        the same pooling puzzle. This puzzle is a `caldera singleton` that is
