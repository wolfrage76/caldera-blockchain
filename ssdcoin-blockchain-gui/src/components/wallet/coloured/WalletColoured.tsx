...
import { AlertDialog, Card, Flex } from '@ssdcoin/core';
...
function BalanceCard(props: BalanceCardProps) {
  ...
  const balance_ptotal_ssdcoin = mojo_to_colouredcoin_string(balance_ptotal);
  const balance_pending_ssdcoin = mojo_to_colouredcoin_string(balance_pending);
  const balance_change_ssdcoin = mojo_to_colouredcoin_string(balance_change);
  const acc_content =
    balancebox_1 +
    balancebox_2 +
    balancebox_ptotal +
    balancebox_3 +
    balance_ptotal_ssdcoin +
    balancebox_unit +
    balancebox_hline +
    balancebox_4 +
    balancebox_row +
