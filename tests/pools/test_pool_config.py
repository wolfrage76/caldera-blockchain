...
from ssdcoin.pools.pool_config import PoolWalletConfig
from ssdcoin.util.config import load_config, save_config, create_default_ssdcoin_config
...
def test_pool_config():
    ...
    create_default_ssdcoin_config(test_root, ["config.yaml"])
