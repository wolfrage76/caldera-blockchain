...
from caldera.pools.pool_config import PoolWalletConfig
from caldera.util.config import load_config, save_config, create_default_caldera_config
...
def test_pool_config():
    ...
    create_default_caldera_config(test_root, ["config.yaml"])
