...
from caldera.farmer.farmer import Farmer
from caldera.protocols import farmer_protocol, harvester_protocol
from caldera.protocols.harvester_protocol import PoolDifficulty
...
class FarmerAPI:
    ...
    async def new_proof_of_space(
        self, new_proof_of_space: harvester_protocol.NewProofOfSpace, peer: ws.WSCalderaConnection
    ):
        """
