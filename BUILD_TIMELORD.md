...
required to run a [Timelord](https://github.com/Caldera-Network/caldera-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Caldera-Network/caldera-blockchain/blob/main/install-timelord.sh)
