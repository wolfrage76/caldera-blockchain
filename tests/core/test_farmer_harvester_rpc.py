...
from caldera.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_pooling_authentication_sk
...
class TestRpc:
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            await client.set_reward_targets(encode_puzzle_hash(new_ph, "xcl"), encode_puzzle_hash(new_ph_2, "xcl"))
            ...
            await client.set_reward_targets(None, encode_puzzle_hash(new_ph_3, "xcl"))
            ...
            assert config["farmer"]["xcl_target_address"] == encode_puzzle_hash(new_ph, "xcl")
            assert config["pool"]["xcl_target_address"] == encode_puzzle_hash(new_ph_3, "xcl")

            new_ph_3_encoded = encode_puzzle_hash(new_ph_3, "xcl")
