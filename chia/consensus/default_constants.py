...
testnet_kwargs = {
    ...
    "SUB_EPOCH_BLOCKS": 4224,  # The number of blocks per sub-epoch, mainnet 384
    "EPOCH_BLOCKS": 50688,  # The number of blocks per epoch, mainnet 4608. Must be multiple of SUB_EPOCH_SB
