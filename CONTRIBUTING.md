...
If you want to learn more about this project, read the [wiki](https://github.com/Caldera-Network/caldera-blockchain/wiki), or check out the [green paper](https://www.caldera.network/assets/CalderaGreenPaper.pdf).
...
If you are not a Caldera organization member, you can enquire about deploying a `beta testnet` in the public dev Discord channel.
