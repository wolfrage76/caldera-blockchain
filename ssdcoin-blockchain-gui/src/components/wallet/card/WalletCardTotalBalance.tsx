...
import { mojo_to_ssdcoin_string } from '../../../util/ssdcoin';
...
export default function WalletCardTotalBalance(props: Props) {
  ...
  return (
    <FarmCard
      ...
      tooltip={
        <Trans>
          This is the total amount of ssdcoin in the blockchain at the current peak
      ...
      value={
        <>
          {mojo_to_ssdcoin_string(value)} {currencyCode}
        </>
      }
      description={
