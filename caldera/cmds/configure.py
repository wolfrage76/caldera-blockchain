...
from caldera.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "8630"
            testnet_introducer = "beta_introducer.caldera.network"
            testnet = "testnet5"
            ...
            mainnet_port = "8620"
            mainnet_introducer = "introducer.caldera.network"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running caldera services for changes to take effect")
