...
from ssdcoin.server.start_full_node import SERVICE_NAME
...
from ssdcoin.consensus.pot_iterations import calculate_iterations_quality
from ssdcoin.full_node.weight_proof import (  # type: ignore
    WeightProofHandler,
