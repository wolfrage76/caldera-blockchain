...
required to run a [Timelord](https://github.com/SSDCoin-Network/ssdcoin-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/SSDCoin-Network/ssdcoin-blockchain/blob/main/install-timelord.sh)
