...
from caldera.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_solutions:
            ...
            if r:
                ...
                if "caldera" in cc_discrepancies:
                    cc_discrepancies["caldera"] = cc_discrepancies["caldera"] + diff
                else:
                    cc_discrepancies["caldera"] = diff
