...
if [ "$NOTARIZE" ]; then
  electron-osx-sign SSDCoin-darwin-arm64/SSDCoin.app --platform=darwin \
...
mv SSDCoin-darwin-arm64 ../build_scripts/dist/
cd ../build_scripts || exit

DMG_NAME="SSDCoin-$SSDCOIN_INSTALLER_VERSION-arm64.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/SSDCoin-darwin-arm64/SSDCoin.app SSDCoin-$SSDCOIN_INSTALLER_VERSION-arm64 \
