...
def init_cmd(ctx: click.Context, create_certs: str):
    ...
    - Make a copy of your Farming Machine CA directory: ~/.ssdcoin/[version]/config/ssl/ca
    - Shut down all ssdcoin daemon processes with `ssdcoin stop all -d`
    - Run `ssdcoin init -c [directory]` on your remote harvester,
      where [directory] is the the copy of your Farming Machine CA directory
    - Get more details on remote harvester on SSDCoin wiki:
      https://github.com/SSDCoin-Network/ssdcoin-blockchain/wiki/Farming-on-many-machines
    """
