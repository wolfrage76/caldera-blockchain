...
mv Caldera-darwin-x64 ../build_scripts/dist/
cd ../build_scripts || exit

DMG_NAME="Caldera-$CALDERA_INSTALLER_VERSION.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/Caldera-darwin-x64/Caldera.app Caldera-$CALDERA_INSTALLER_VERSION \
