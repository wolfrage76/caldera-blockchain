...
from caldera.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from caldera.harvester.harvester import Harvester
from caldera.plotting.plot_tools import PlotInfo, parse_plot_info
from caldera.protocols import harvester_protocol
from caldera.protocols.farmer_protocol import FarmingInfo
from caldera.protocols.harvester_protocol import Plot
from caldera.protocols.protocol_message_types import ProtocolMessageTypes
from caldera.server.outbound_message import make_msg
...
from caldera.util.api_decorators import api_request, peer_required
from caldera.util.ints import uint8, uint32, uint64
from caldera.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSCalderaConnection
    ):
        """
