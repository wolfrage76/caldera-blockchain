...
from caldera.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import puzzle_for_pk
...
def postfarm_parent_id(block_height: uint32, genesis_challenge: bytes32) -> bytes32:
